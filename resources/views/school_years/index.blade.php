                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('School Years') }}</h3>
                                <p class="text-sm mb-0">
                                        {{ __('This is an example of school_year management. This is a minimal setup in order to get started fast.') }}
                                    </p>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('school_year.create') }}" class="btn btn-sm btn-primary">{{ __('Add New School Year') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="{{ route('school_year.edit', $model) }}">{{ __('Edit') }}</a>
                                                
                                                    <form action="{{ route('school_year.destroy', $model->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
