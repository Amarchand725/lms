                        ...
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="text-sm mb-0">
                                        {{ __('This is an example of department management. This is a minimal setup in order to get started fast.') }}
                                    </p>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('department.create') }}" class="btn btn-sm btn-primary">{{ __('Add New Department') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="{{ route('department.edit', $model) }}">{{ __('Edit') }}</a>
