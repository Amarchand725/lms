                        ...
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="text-sm mb-0">
                                    {{ __('This is an example of subject management. This is a minimal setup in order to get started fast.') }}
                                </p>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('subject.create') }}" class="btn btn-sm btn-primary">{{ __('Add Subject') }}</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-flush"  id="datatable-basic">
                            ...
                            <tbody>
                                @foreach ($models as $subject)
                                    <tr>
                                        <td>{{ $subject->hasSemester->name }}</td>
                                        <td>{{ $subject->title }}</td>
                                        <td>{{ $subject->code }}</td>
                                        <td>{{ $subject->unit }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="{{ route('subject.edit', $subject) }}">{{ __('Edit') }}</a>
