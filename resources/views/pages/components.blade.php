...
@push('css')
    <link rel="stylesheet" href="{{ asset('public/admin/assets') }}/vendor/select2/dist/css/select2.min.css">
    <link rel="stylesheet" href="{{ asset('public/admin/assets') }}/vendor/quill/dist/quill.core.css">
@endpush

@push('js')
    <script src="{{ asset('public/admin/assets') }}/vendor/select2/dist/js/select2.min.js"></script>
    <script src="{{ asset('public/admin/assets') }}/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset('public/admin/assets') }}/vendor/nouislider/distribute/nouislider.min.js"></script>
    <script src="{{ asset('public/admin/assets') }}/vendor/quill/dist/quill.min.js"></script>
    <script src="{{ asset('public/admin/assets') }}/vendor/dropzone/dist/min/dropzone.min.js"></script>
    <script src="{{ asset('public/admin/assets') }}/vendor/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
@endpush
