    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="card">
                    <!-- Card image -->
                    <img class="card-img-top" src="{{ asset('public/admin/assets') }}/img/theme/img-1-1000x900.jpg" alt="Image placeholder">
                    <!-- Card body -->
                    <div class="card-body">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder" src="{{ asset('public/admin/assets') }}/img/theme/team-5.jpg">
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                        ...
                        <div class="list-group list-group-flush">
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    <div>
                                        <div class="d-flex w-100 align-items-center">
                                            <img src="{{ asset('public/admin/assets') }}/img/theme/team-1.jpg" alt="Image placeholder" class="avatar avatar-xs mr-2" />
                            ...
                            <a href="#" class="list-group-item list-group-item-action flex-column align-items-start py-4 px-4">
                                <div class="d-flex w-100 justify-content-between">
                                    <div>
                                        <div class="d-flex w-100 align-items-center">
                                            <img src="{{ asset('public/admin/assets') }}/img/theme/team-2.jpg" alt="Image placeholder" class="avatar avatar-xs mr-2" />
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('public/admin/assets') }}/img/icons/cards/mastercard.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('public/admin/assets') }}/img/icons/cards/paypal.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-lg-4">
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <img src="{{ asset('public/admin/assets') }}/img/icons/cards/visa.png" alt="Image placeholder" />
                            </div>
                            <div class="col-auto">
                                <span class="badge badge-lg badge-success">Active</span>
                            </div>
