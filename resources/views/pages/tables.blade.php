            ...
            <div class="table-responsive">
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        <tr>
                            <td class="table-user">
                                <img src="{{ asset('public/admin/assets') }}/img/theme/team-1.jpg" class="avatar rounded-circle mr-3">
                                <b>John Michael</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="table-user">
                                <img src="{{ asset('public/admin/assets') }}/img/theme/team-2.jpg" class="avatar rounded-circle mr-3">
                                <b>Alex Smith</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="table-user">
                                <img src="{{ asset('public/admin/assets') }}/img/theme/team-3.jpg" class="avatar rounded-circle mr-3">
                                <b>Samantha Ivy</b>
                            </td>
                            <td>
