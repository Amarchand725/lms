    ...
    <div class="container-fluid mt--6">
        <div class="row card-wrapper">
            <div class="col-lg-4">
                ...
                <div class="card">
                    <!-- Card image -->
                    <img class="card-img-top" src="{{ asset('public/admin/assets') }}/img/theme/img-1-1000x600.jpg" alt="Image placeholder">
                    <!-- List group -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('public/admin/assets') }}/img/theme/team-4.jpg" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="#!">
                            <img src="{{ asset('public/admin/assets') }}/img/theme/team-1.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 140px;">
                        </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="card bg-dark text-white border-0">
                    <img class="card-img" src="{{ asset('public/admin/assets') }}/img/theme/img-1-1000x600.jpg" alt="Card image">
