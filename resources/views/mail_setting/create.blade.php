...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('Add Mail Setting') }}</li>
        @endcomponent
    @endcomponent
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            {{-- <div class="col-4 text-right">
                                <a href="{{ route('mail_setting.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div> --}}
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('mail_setting.store') }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('mail_mailer') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_mailer" id="input-mail_mailer" class="form-control{{ $errors->has('mail_mailer') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_mailer') }}" value="{{ old('mail_mailer') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_host') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_host" id="input-mail_host" class="form-control{{ $errors->has('mail_host') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_host') }}" value="{{ old('mail_host') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_port') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_port" id="input-mail_port" class="form-control{{ $errors->has('mail_port') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_port') }}" value="{{ old('mail_port') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_username') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_username" id="input-mail_username" class="form-control{{ $errors->has('mail_username') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_username') }}" value="{{ old('mail_username') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_password" id="input-mail_password" class="form-control{{ $errors->has('mail_password') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_password') }}" value="{{ old('mail_password') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_encryption') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_encryption" id="input-mail_encryption" class="form-control{{ $errors->has('mail_encryption') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_encryption') }}" value="{{ old('mail_encryption') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_from_address') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_from_address" id="input-mail_from_address" class="form-control{{ $errors->has('mail_from_address') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_from_address') }}" value="{{ old('mail_from_address') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('mail_from_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mail_from_name" id="input-mail_from_name" class="form-control{{ $errors->has('mail_from_name') ? ' is-invalid' : '' }}" placeholder="{{ __('mail_from_name') }}" value="{{ old('mail_from_name') }}" autofocus>
