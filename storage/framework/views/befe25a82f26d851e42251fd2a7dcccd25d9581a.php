                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('School Years')); ?></h3>
                                <p class="text-sm mb-0">
                                        <?php echo e(__('This is an example of school_year management. This is a minimal setup in order to get started fast.')); ?>

                                    </p>
                            </div>
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('school_year.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add New School Year')); ?></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush"  id="datatable-basic">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col"><?php echo e(__('Year')); ?></th>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="<?php echo e(route('school_year.edit', $model)); ?>"><?php echo e(__('Edit')); ?></a>
                                                
                                                    <form action="<?php echo e(route('school_year.destroy', $model->id)); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/school_years/index.blade.php ENDPATH**/ ?>