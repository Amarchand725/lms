...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?> 
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Edit subject')); ?></li>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('subject.update', $model->id)); ?>" autocomplete="off">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group<?php echo e($errors->has('semester_id') ? ' has-danger' : ''); ?>">
                                    ...
                                    <select name="semester_id" id="input-semester_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($semester->id); ?>" <?php echo e($model->semester_id==$semester->id?'selected':''); ?>><?php echo e($semester->name); ?></option>
                                ...
                                <div class="form-group<?php echo e($errors->has('title') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control<?php echo e($errors->has('title') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e(old('title', $model->title)); ?>"  required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('code') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="code" id="input-code" class="form-control<?php echo e($errors->has('code') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Subject Code')); ?>" value="<?php echo e(old('code', $model->code)); ?>"  required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('unit') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="number" name="unit" id="input-unit" class="form-control<?php echo e($errors->has('unit') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Subject Units')); ?>" value="<?php echo e(old('unit', $model->unit)); ?>"  required autofocus>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/subjects/edit.blade.php ENDPATH**/ ?>