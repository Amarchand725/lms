                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Contents')); ?></h3>
                                <p class="text-sm mb-0">
                                        <?php echo e(__('This is an example of content management. This is a minimal setup in order to get started fast.')); ?>

                                    </p>
                            </div>
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('content.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add content')); ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($model->content); ?></td>
                                        <td>
                                            <?php if($model->status): ?>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="<?php echo e(route('content.edit', $model)); ?>"><?php echo e(__('Edit')); ?></a>
                                                
                                                    <form action="<?php echo e(route('content.destroy', $model->id)); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/contents/index.blade.php ENDPATH**/ ?>