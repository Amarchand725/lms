                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Role Management')); ?></h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('role.update', $role)); ?>" autocomplete="off">
                            <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/roles/edit.blade.php ENDPATH**/ ?>