        ...
        <div class="row">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-secondary" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form" action="<?php echo e(route('event.store',$id)); ?>" method="post" >
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="starting_date" min="<?php echo e(Carbon\Carbon::now()); ?>" class="form-control form-control-alternative ">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Ending Date</label>
                                        <input type="date" name="ending_date" min="<?php echo e(Carbon\Carbon::now()); ?>" class="form-control form-control-alternative">
                                    </div>
                                    <div class="form-group">
            ...
            <table id="customers">
                ...
                <tr>
                    ...
                    <td><?php echo e($event->status==1? "Active":"Inactive"); ?></td>
                </tr>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/events/calendar.blade.php ENDPATH**/ ?>