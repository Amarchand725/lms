    ...
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            <?php $__env->slot('title'); ?>
                <?php echo e(__('Components')); ?>

            <?php $__env->endSlot(); ?>

            <li class="breadcrumb-item"><a href="<?php echo e(route('page.index', 'components')); ?>"><?php echo e(__('Forms')); ?></a></li>
...
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('public/admin/assets')); ?>/vendor/select2/dist/css/select2.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('public/admin/assets')); ?>/vendor/quill/dist/quill.core.css">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/select2/dist/js/select2.min.js"></script>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/nouislider/distribute/nouislider.min.js"></script>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/quill/dist/quill.min.js"></script>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/dropzone/dist/min/dropzone.min.js"></script>
    <script src="<?php echo e(asset('public/admin/assets')); ?>/vendor/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', [
    'parentSection' => 'forms',
    'elementName' => 'components'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/pages/components.blade.php ENDPATH**/ ?>